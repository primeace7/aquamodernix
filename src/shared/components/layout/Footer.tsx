      ...
      <div className="container grid gap-10 py-14 md:grid-cols-3">
        <div>
          ...
          <p className="mt-2 max-w-xs text-sm text-background/70">
            Aquaculture, poultry, and agribusiness consulting built on
            hands-on expertise and a track record of results across Nigeria.
          </p>
        </div>
        ...
        <nav className="grid grid-cols-2 gap-2 text-sm text-background/80">
          ...
          <Link to="/aquaculture" className="hover:text-accent">Aquaculture</Link>
          <Link to="/poultry" className="hover:text-accent">Poultry</Link>
